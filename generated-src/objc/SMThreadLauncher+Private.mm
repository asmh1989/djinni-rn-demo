...
: public ::smobiler::ThreadLauncher
, public ::djinni::ObjcProxyCache::Handle<ObjcType>
{
public:
    using Handle::Handle;
    void start_thread(const std::string & c_name, const std::shared_ptr<::smobiler::AsyncTask> & c_run_fn) override
    {
        @autoreleasepool {
            [Handle::get() startThread:(::djinni::String::fromCpp(c_name))
