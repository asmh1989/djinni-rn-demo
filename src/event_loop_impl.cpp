...
EventLoopRef::EventLoopRef(shared_ptr<EventLoop> loop) : m_loop {std::move(loop)} {}
...
EventLoopCpp::EventLoopCpp(const shared_ptr<ThreadLauncher> & launcher) : m_stop(false), m_done(false) {
